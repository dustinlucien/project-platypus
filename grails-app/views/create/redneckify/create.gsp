...
<body>
  <div id="header" class="span-23 prepend-1">
    <a href="${link(controller:'create')}" class="span-7" id="logoheader"><span class="hidden">Redneckify</span></a>
    <div id="mainNav">
      <a href="${link(controller:'create')}" class="span-5" id="redneskifyMeActive"><span class="hidden">Redneckify Me</span></a>
      <a href="${link(controller:'gallery')}" class="span-3" id="gallery"><span class="hidden">Redneckify Me</span></a>
      <a href="${link(controller:'shop')}" class="span-3" id="merch"><span class="hidden">Redneckify Me</span></a>
      <a href="${link(controller:'about')}" class="span-4 last" id="aboutUs"><span class="hidden">Redneckify Me</span></a>
    </div>
  </div>

  <div id="midNav" class="span-24">
    <a href="${link(controller:'create')}" class="span-10" id="subh1"></a>
    <a href="${link(controller:'create')}" class="span-7" id="subh2Active"></a>
    <a href="${link(controller:'share')}" class="span-6" id="subh3"></a>
  </div>
